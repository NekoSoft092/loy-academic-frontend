...
export function SideBarComponent(props: ISideBarComponentProps): JSX.Element {
    ...
    return (
        <div className='bg-base-100 flex flex-col justify-between pb-4' style={{ width: '20%', minWidth: '0px', maxWidth: '400px', paddingLeft: '10px', paddingRight: '10px' }}>
            <div className=''>
                <div className="flex-row justify-center align-end logo" style={{ marginTop: '0rem' }}>
                ...
                <ul className="menu bg-base-300 rounded-box mt-6">
                    ...
                    <li onClick={() => {
                        navigate(RoutePath.MARKETPLACE)
                    }}>
                        <a>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
            ...
            <div className=''>
                <button className="btn bg-primary text-black flex justify-center items-center w-full mb-4" onClick={()=> {
                    navigate(RoutePath.MARKETPLACE)
                }}>
